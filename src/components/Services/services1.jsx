...
// 			<Link to={routeTo} className='flex justify-center items-center text-green-900 cursor-pointer'>
// 				Learn More
		...
		<div>
			...
			{/* <div className='lg:px-52 md:px-12 px-6 lg:py-24 md:py-20 py-16 bg-[#c4c4c430]'>
				...
				<div className=' flex md:flex-row flex-col'>
					...
					<ServiceType serviceType='FUMIGATION AND PEST CONTROL' routeTo='/fumigationServices' serviceHighlight='Using fumigation sheets, we totally cover an area with appropriate gaseous fumigants for the purpose of disinfecting or to exterminate pests within an enclosed space.' />
				</div>
				<div className=' flex md:flex-row flex-col-reverse'>
					<ServiceType serviceType='PAINTING SERVICES' routeTo='/paintServices' serviceHighlight='We give your home a distinctive, enticing appearance with a splash of class. Although we work within your taste and budget, quality is not compromised.' />
					<div className='md:w-1/2 w-full'>
